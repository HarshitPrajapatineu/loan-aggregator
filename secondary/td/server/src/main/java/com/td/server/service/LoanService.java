...
import com.td.server.dto.LoanDTO;
import com.td.server.entity.Loan;
import com.td.server.repository.DatabaseConnector;
import com.td.server.repository.LoanRepository;
...
public class LoanService {
	...
	public boolean deleteLoan(String refid) 
	{
		...
		try 
		{
			connection = com.td.server.repository.DatabaseConnector.getInstance().getConnection();
