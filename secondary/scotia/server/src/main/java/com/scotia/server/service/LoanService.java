package com.scotia.server.service;
...
import com.scotia.server.dto.LoanDTO;
import com.scotia.server.entity.Loan;
import com.scotia.server.repository.*;
...
public class LoanService {
	...
	public boolean deleteLoan(String refid) 
	{
		...
		try 
		{
			connection = com.scotia.server.repository.DatabaseConnector.getInstance().getConnection();
