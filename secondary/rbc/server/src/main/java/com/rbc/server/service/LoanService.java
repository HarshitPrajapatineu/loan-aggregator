package com.rbc.server.service;
...
import com.rbc.server.repository.DatabaseConnector;
import com.rbc.server.dto.LoanDTO;
import com.rbc.server.entity.Loan;
import com.rbc.server.repository.LoanRepository;
...
public class LoanService {
	...
	public boolean deleteLoan(String refid) 
	{
		...
		try 
		{
			connection = com.rbc.server.repository.DatabaseConnector.getInstance().getConnection();
